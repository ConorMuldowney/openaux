...
**Host**:
An authenticated user with a verified email who creates and configures an Open Aux.
_Avoid_: Admin, organizer

**Participant**:
An invited authenticated user who submits one final Entry to an Open Aux.
_Avoid_: Competitor, producer

**Entry**:
A Participant's submitted track for a specific Open Aux.
...
**Participation Scope**:
The rule defining who can submit Entries to an Open Aux.
